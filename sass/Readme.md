...
folder are mapped to the application's root namespace, 'tool_control_system'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "tool_control_system"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'tool_control_system' in the same way
as `"tool_control_system/sass/src"`.
